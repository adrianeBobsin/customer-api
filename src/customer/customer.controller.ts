...
export class CustomerController {
  constructor(private customerRepository: CustomerRepository, private redis: RedisConfig) {}
  ...
  @Get('/:id')
  async getCustomerById(@Param('id') id: string, @Headers() headers: Record<string, string>) {
    await this.tokenValidation(headers.authorization)
